...
CREATE TABLE tb_user (id_user numeric(19, 0) NOT NULL, id_profile numeric(19, 0) NOT NULL, dt_create timestamp NOT NULL, ds_email varchar(255) NOT NULL UNIQUE, ds_password varchar(255), nu_ddd_cel varchar(2) NOT NULL, nu_cel varchar(9) NOT NULL, nm_user varchar(255) NOT NULL, dt_last_login timestamp, ds_token varchar(500), dt_expiry_token timestamp, is_email_verified bool NOT NULL, PRIMARY KEY (id_user));
CREATE TABLE tb_user_admin (id_user_admin numeric(19, 0) NOT NULL, id_profile numeric(19, 0) NOT NULL, dt_create timestamp NOT NULL, ds_email varchar(255) NOT NULL UNIQUE, ds_password varchar(255), nu_ddd_cel varchar(2) NOT NULL, nu_cel varchar(9) NOT NULL, nm_user varchar(255) NOT NULL, dt_last_login timestamp, ds_token varchar(500), dt_expiry_token timestamp, is_email_verified bool NOT NULL, PRIMARY KEY (id_user_admin));
